    ...
    <div class="container">
        ...
        <form action="" method="POST" class="order">
            ...
            <fieldset>
                ...
                <input type="tel" name="contact" placeholder="Enter phone name" class="input-responsive" required>
        ...
        <?php 
         //check whether submit button is selected or not
